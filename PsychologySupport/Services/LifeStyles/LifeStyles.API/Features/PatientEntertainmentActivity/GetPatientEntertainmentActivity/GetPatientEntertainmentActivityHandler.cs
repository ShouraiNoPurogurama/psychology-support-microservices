...
namespace LifeStyles.API.Features.PatientEntertainmentActivity.GetPatientEntertainmentActivity
{
    ...
    public record GetPatientEntertainmentActivityResult(IEnumerable<Models.PatientEntertainmentActivity> PatientEntertainmentActivities);
    ...
    {
        public async Task<GetPatientEntertainmentActivityResult> Handle(GetPatientEntertainmentActivityQuery request, CancellationToken cancellationToken)
        {
