...
public sealed class AttachCategoryTagsToPostCommandValidator : AbstractValidator<AttachCategoryTagsToPostCommand>
{
    public AttachCategoryTagsToPostCommandValidator()
    {
