...
using Post.Domain.Abstractions.Aggregates.CommentAggregate.ValueObjects;
using Post.Domain.Abstractions.Aggregates.PostAggregate.ValueObjects;

namespace Post.Domain.Abstractions.Aggregates.CommentAggregate;
...
public sealed class Comment : AggregateRoot<Guid>, ISoftDeletable
{
        ...
        string? parentPath = null)
    {
        ...
        var hierarchy = new CommentHierarchy(parentCommentId, parentPath);
    ...
    public void UpdateContent(string newContent, Guid editorAliasId)
    {
        ...
        Content = new CommentContent(newContent);
