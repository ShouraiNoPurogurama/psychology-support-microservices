...
public interface IUserActivityRepository
{
    ...
    Task<IReadOnlyList<FeedSeenEntry>> GetSeenPostsByDayAsync(Guid aliasId, DateOnly ymd, CancellationToken ct);
    Task<IReadOnlyList<FeedSeenEntry>> GetRecentSeenPostsAsync(Guid aliasId, int days = 7, CancellationToken ct = default);
