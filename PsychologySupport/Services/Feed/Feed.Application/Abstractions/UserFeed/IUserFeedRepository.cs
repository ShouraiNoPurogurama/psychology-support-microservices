...
public interface IUserFeedRepository
{
    ...
    Task<bool> RemoveFeedItemAsync(Guid aliasId, DateOnly ymdBucket, short shard, Guid postId, CancellationToken ct);
    Task<IReadOnlyList<UserFeedItem>> GetFeedItemsAsync(Guid aliasId, DateOnly ymdBucket, short shard, int limit = 50, CancellationToken ct = default);
