...
using Billing.Infrastructure.Resilience.Entities;
...
namespace Billing.Infrastructure.Resilience.Services
{
    public sealed class IdempotencyService : IIdempotencyService
    {
        ...
        public IdempotencyService(BillingDbContext db, IIdempotencyHashAccessor hashAccessor, Func<string>? getRequestHash = null)
        {
            _db = db;
