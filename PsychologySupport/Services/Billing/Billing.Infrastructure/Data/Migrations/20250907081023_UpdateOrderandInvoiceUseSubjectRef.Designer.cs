...
namespace Billing.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250907081023_UpdateOrderandInvoiceUseSubjectRef")]
    partial class UpdateOrderandInvoiceUseSubjectRef
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.IdempotencyKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex(new[] { "IdempotencyKey1" }, "idempotency_keys_idempotency_key_key")
                        .IsUnique()
                        .HasDatabaseName("ix_idempotency_keys_idempotency_key1");

                    b.ToTable("idempotency_keys", (string)null);
                });

            modelBuilder.Entity("Billing.API.Domains.Billings.Models.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.InvoiceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.InvoiceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.Invoice", b =>
                {
                    b.HasOne("Billing.API.Domains.Billings.Models.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.InvoiceItem", b =>
                {
                    b.HasOne("Billing.API.Domains.Billings.Models.InvoiceSnapshot", "InvoiceSnapshot")
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.InvoiceSnapshot", b =>
                {
                    b.HasOne("Billing.API.Domains.Billings.Models.Invoice", "Invoice")
                        .WithOne("InvoiceSnapshot")
                        .HasForeignKey("Billing.API.Domains.Billings.Models.InvoiceSnapshot", "InvoiceId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Billing.API.Domains.Billings.Models.Order", b =>
                {
                    b.HasOne("Billing.API.Domains.Billings.Models.IdempotencyKey", "IdempotencyKey")
                        .WithMany("Orders")
