...
namespace Billing.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250914142921_UpdateIdempotencyKey")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Billing.Domain.Models.InvoiceSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.Infrastructure.Resilience.Entities.IdempotencyKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Billing.Domain.Models.Invoice", b =>
                {
                    b.HasOne("Billing.Domain.Models.Order", "Order")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("Billing.Domain.Models.InvoiceItem", b =>
                {
                    b.HasOne("Billing.Domain.Models.InvoiceSnapshot", "InvoiceSnapshot")
            ...
            modelBuilder.Entity("Billing.Domain.Models.InvoiceSnapshot", b =>
                {
                    b.HasOne("Billing.Domain.Models.Invoice", "Invoice")
                        ...
                        .HasForeignKey("Billing.Domain.Models.InvoiceSnapshot", "InvoiceId")
                        .IsRequired()
