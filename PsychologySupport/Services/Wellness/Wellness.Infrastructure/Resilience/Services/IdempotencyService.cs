...
namespace Wellness.Infrastructure.Resilience.Services
{
    public sealed class IdempotencyService : IIdempotencyService
    {
        ...
        public IdempotencyService(WellnessDbContext db, IIdempotencyHashAccessor hashAccessor, Func<string>? getRequestHash = null)
        {
            _db = db;
