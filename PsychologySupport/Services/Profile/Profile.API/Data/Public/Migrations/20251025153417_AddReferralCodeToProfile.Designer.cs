...
namespace Profile.API.Data.Public.Migrations
{
    ...
    [Migration("20251025153417_AddReferralCodeToProfile")]
    partial class AddReferralCodeToProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Profile.API.Models.Public.AffiliateProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_affiliate_profiles");

                    b.ToTable("affiliate_profiles", "public");
                });
            ...
            modelBuilder.Entity("Profile.API.Models.Public.AffiliateProfile", b =>
                {
                    b.OwnsOne("BuildingBlocks.Data.Common.ContactInfo", "ContactInfo", b1 =>
                        {
                            b1.Property<Guid>("AffiliateProfileId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.HasKey("AffiliateProfileId");

                            b1.ToTable("affiliate_profiles", "public");

                            b1.WithOwner()
                                .HasForeignKey("AffiliateProfileId")
                                .HasConstraintName("fk_affiliate_profiles_affiliate_profiles_id");
                        });
