...
namespace Subscription.API.UserSubscriptions.Features02.UpdateUserSubscription;
...
public class UpdateUserSubscriptionEndpoint : ICarterModule
{
    ...
    {
        app.MapPut("/v2/userSubscription", async ([FromBody] UpdateUserSubscriptionV2Request request, ISender sender, HttpContext httpContext) =>
            {
                // Authorization check
