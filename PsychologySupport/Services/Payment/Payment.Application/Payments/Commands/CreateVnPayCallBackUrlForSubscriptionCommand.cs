...
public record CreateVnPayCallBackUrlForSubscriptionCommand(BuySubscriptionDto BuySubscription)
    : ICommand<CreateVnPayCallBackUrlForSubscriptionResult>;
...
{
    public async Task<CreateVnPayCallBackUrlForSubscriptionResult> Handle(CreateVnPayCallBackUrlForSubscriptionCommand request,
