...
namespace Media.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250911063600_UpdateIdempotency")]
    partial class UpdateIdempotency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Media.API.Media.Models.MediaOwner", b =>
                {
                    ...
                    b.Property<string>("MediaOwnerId")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Media.API.Media.Models.OutboxMessage", b =>
                {
                    ...
                    b.Property<Guid?>("CreatedAtActor")
                        .HasColumnType("uuid")
                        .HasColumnName("created_at_actor");
